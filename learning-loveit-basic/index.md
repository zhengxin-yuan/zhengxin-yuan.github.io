...
{{< admonition failure "声明">}}
本文转自[LoveIt主题](https://hugoloveit.com/zh-cn/)网站，仅做学习备份使用，强烈建议读者前往原址进行阅读，谢谢！
{{< /admonition >}}
...
![基本配置下的预览](/images/learning/hugo-loveit/basic/basic-configuration-preview.zh-cn.png "基本配置下的预览")
...
![完整配置下的预览](/images/learning/hugo-loveit/basic/complete-configuration-preview.zh-cn.png "完整配置下的预览")
...
![语言切换](/images/learning/hugo-loveit/basic/language-switch.gif "语言切换")
