...
{{< figure src="/images/learning/python-studying/plotfigure/plot.png" title="Fig.1. 默认格式" >}}
{{< /style >}}
...
{{< style "width: 100%; margin: 0 auto;" >}}
{{< figure src="/images/learning/python-studying/plotfigure/plot1.png" title="Fig.2. 改动格式" >}}
{{< /style >}}
...
{{< style "width: 100%; margin: 0 auto;" >}}
{{< figure src="/images/learning/python-studying/plotfigure/plot2.png" title="Fig.3. 有趣的格式" >}}
{{< /style >}}
...
{{< style "width: 100%; margin: 0 auto;" >}}
{{< figure src="/images/learning/python-studying/plotfigure/Anatomy_of_a_figure.png" title="Fig.4. 科研图片的构造" >}}
{{< /style >}}
