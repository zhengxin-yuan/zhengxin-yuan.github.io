...
{{< figure src="/images/Science/Latex/Latex_01.png" title="Fig. 1. TeX Live 2019 下载 A" >}}
{{< /style >}}

{{< style "width: 100%; margin: 0 auto;" >}}
{{< figure src="/images/Science/Latex/Latex_02.png" title="Fig. 2. TeX Live 2019 下载 B" >}}
{{< /style >}}


下载完成后正常安装，选择自己喜欢的安装路径，安装过程如图所示：
{{< style "width: 55%; margin: 0 auto;" >}}
{{< figure src="/images/Science/Latex/Latex_03.png" title="Fig. 3. TeX Live 安装中" >}}
{{< /style >}}
...
{{< style "width: 100%; margin: 0 auto;" >}}
{{< figure src="/images/Science/Latex/Latex_04.png" title="Fig. 4. 配置镜像源" >}}
{{< /style >}}
...
按照下图步骤，下载相应版本：
{{< style "width: 100%; margin: 0 auto;" >}}
{{< figure src="/images/Science/Latex/Latex_05.png" title="Fig. 5. TeXstudio 下载" >}}
{{< /style >}}

### 步骤四：配置编译器 TeXstudio
进行如下配置，使用 XeTeX 进行编译
{{< style "width: 100%; margin: 0 auto;" >}}
{{< figure src="/images/Science/Latex/Latex_06.png" title="Fig. 6. 配置编译器 TeXstudio" >}}
{{< /style >}}

至此，在你的电脑上已经可以快乐地使用 LaTeX 对论文进行排版了。关于后续深入地学习，需要读者自行查阅资料。
