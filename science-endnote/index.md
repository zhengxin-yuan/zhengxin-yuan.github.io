...
{{< figure src="/images/Science/EndNote/EndNoteEC_01.png" title="Fig. 1. 建立文献类型" >}}
{{< /style >}}

### 步骤2
随后，点击【Modify Reference Types】进行新格式设置，设置内容如下图所示，完成后点击确定。
{{< style "width: 90%; margin: 0 auto;" >}}
{{< figure src="/images/Science/EndNote/EndNoteEC_02.png" title="Fig. 2. 取名中文文献类型" >}}
{{< /style >}}
...
{{< style "width: 90%; margin: 0 auto;" >}}
{{< figure src="/images/Science/EndNote/EndNoteEC_03.png" title="Fig. 3. 转换文献类型" >}}
{{< /style >}}
...
{{< style "width: 90%; margin: 0 auto;" >}}
{{< figure src="/images/Science/EndNote/EndNoteEC_04.png" title="Fig. 4&5. 类型描述" >}}
{{< /style >}}
...
{{< style "width: 90%; margin: 0 auto;" >}}
{{< figure src="/images/Science/EndNote/EndNoteEC_06.png" title="Fig. 6. 建立模板" >}}
{{< /style >}}
...
```
如图所示。其中，制表符在右上角插入。
{{< figure src="/images/Science/EndNote/EndNoteEC_07.png" title="Fig. 7. 示例" >}}

### 步骤8
英文作者设置，Author Lists 的设置代表英文文献格式，作者前后之间用“,”分隔，显示前 3 位作者，超过 3 个作者缩略为 “, et al. ”。如图所示。
{{< style "width: 90%; margin: 0 auto;" >}}
{{< figure src="/images/Science/EndNote/EndNoteEC_08.png" title="Fig. 8. 英文作者设置" >}}
{{< /style >}}

### 步骤9
Editor Lists 的设置代表中文文献格式，作者前后之间用 “,” 分隔，显示前 3 位作者，超过3个作者缩略为 “, 等.” ，如图所示。
{{< style "width: 90%; margin: 0 auto;" >}}
{{< figure src="/images/Science/EndNote/EndNoteEC_09.png" title="Fig. 9. 中文作者显示设置" >}}
{{< /style >}}
...
{{< style "width: 90%; margin: 0 auto;" >}}
{{< figure src="/images/Science/EndNote/EndNoteEC_10.png" title="Fig. 10. 参考文献布局设置" >}}
{{< /style >}}
...
{{< style "width: 90%; margin: 0 auto;" >}}
{{< figure src="/images/Science/EndNote/EndNoteEC_11.png" title="Fig. 11. Word 中的设置" >}}
{{< /style >}}
